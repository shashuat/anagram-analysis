...
This variant uses smaller DeepFloyd IF models (S instead of M) to explore the minimum
resource requirements while maintaining illusion quality. Addresses practical deployment
constraints by reducing GPU memory requirements and generation time.

Tests model size impact on:
- Alignment score (A) and Concealment score (C)
- Generation speed
- GPU memory usage
- Success rate of producing recognizable illusions
"""
...
# Make DeepFloyd IF stage I - SMALL model
print("Loading DeepFloyd IF Stage I (Small)...")
...
# Make DeepFloyd IF stage II - SMALL model
print("Loading DeepFloyd IF Stage II (Small)...")
...
# Save metadata
save_metadata(views, args, save_dir, variant="variant2_lightweight")
